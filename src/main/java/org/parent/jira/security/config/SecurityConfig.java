package org.parent.jira.security.config;
...
import org.parent.jira.security.jwt.filter.JwtAccessTokenGeneralFilter;
import org.parent.jira.security.jwt.filter.JwtRefreshTokenGeneralFilter;
    ...
    SecurityFilterChain logoutSecurityFilterChain(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity
                ...
                .logout(logout -> logout
                        ...
                        .logoutSuccessHandler(((req, response, a) -> {
